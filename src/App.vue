...
<template>
  <div class="app-container">
    ...
    <div
      v-if="!isOnline"
      class="offline-banner flex justify-between items-center px-4 py-2"
    >
      <span>⚠️ Офлайн-режим. Данные сохраняются локально.</span>
      <button @click="isOnline = !isOnline" class="ml-4">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="25px"
          height="25px"
